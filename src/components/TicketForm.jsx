  ...
  return (
    ...
    >
      ...
      <div className="mb-6">
        ...
        {errors.avatar ? <ErrorMsg id="avatar-error" msg={errors.avatar} /> : <p id="avatar-hint" className="mt-1.5 text-[#7a6e8a] text-xs">Upload your photo (JPG, PNG, GIF — max 500KB).</p>}
      </div>
      ...
      <div className="mb-6">
        ...
        {errors.github ? <ErrorMsg id="github-error" msg={errors.github} /> : <p id="github-hint" className="mt-1.5 text-[#7a6e8a] text-xs">Your GitHub handle — no @ needed.</p>}
      </div>
