    ...
    >
      ...
      >
        ...
        <div className="relative z-10 p-6 sm:p-8">
          {/* Top row: event info + ticket number */}
          <div className="flex items-start justify-between mb-8 gap-4">
            ...
            <div
              className="text-emerald-900/60 font-black text-6xl sm:text-7xl leading-none select-none"
              aria-hidden="true"
          ...
          <div className="relative my-0" aria-hidden="true">
            <div className="border-t-2 border-dashed border-white/[0.08] relative">
              <div className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-1/2 w-6 h-6 bg-[#0d0d0d] rounded-full" />
              <div className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-1/2 w-6 h-6 bg-[#0d0d0d] rounded-full" />
            </div>
          </div>
          ...
          <div className="mt-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              {avatarPreview ? (
                <img
                  ...
                  className="w-14 h-14 rounded-xl object-cover border-2 border-emerald-400/30 shrink-0"
                />
              ) : (
                <div className="w-14 h-14 rounded-xl bg-emerald-500/10 border-2 border-emerald-400/20 flex items-center justify-center shrink-0">
              ...
              <div>
                ...
                <a
                  ...
                  className="flex items-center gap-1.5 text-gray-500 text-sm hover:text-emerald-400 transition-colors"
            ...
            <div className="hidden sm:block text-right">
              <p className="text-emerald-900/70 text-xs uppercase tracking-widest mb-0.5">Ticket No.</p>
              <p className="text-gray-600 font-mono font-bold text-base">#{ticketNumber.current}</p>
            </div>
          </div>
        </div>
      </article>

      <p className="text-center text-gray-700 text-xs mt-4" aria-live="polite">
      ...
      <div className="flex justify-center mt-5">
        <button
          ...
          className="flex items-center gap-2 px-6 py-3 rounded-xl bg-emerald-500 hover:bg-emerald-400 active:bg-emerald-600 text-white font-semibold text-sm transition-colors duration-200 shadow-lg shadow-emerald-500/20"
        >
